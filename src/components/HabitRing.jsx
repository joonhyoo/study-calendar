// --- Ring Component ---
// Generated from Claude Sonnet 4.6
...
export const HabitRing = ({ count, goal, color, size, stroke }) => {
	const segments = goal;
				...
				return (
					<g key={i}>
						...
						<path
							...
							strokeDashoffset={isFilled ? 0 : segmentArcLength}
							style={{
								transition: isFilled
									? `stroke-dashoffset 0.45s cubic-bezier(0.22, 1, 0.36, 1) ${i * 30}ms`
